...
export function ProcessoDetalhesTimelineModal({
  ...
  return (
    <>
            ...
            <div className="flex flex-wrap items-center justify-between gap-2">
              <div>
                ...
                <DialogDescription className="text-xs sm:text-sm">
                  Colaborador <strong className="text-foreground">
                  ...
                  <div className="mt-3 rounded-lg border border-emerald-200/80 bg-emerald-50/50 p-3 text-xs space-y-2">
                    ...
                    <div className="space-y-1.5">
                      {processoAnexos.map((anexo, aIdx) => {
                        ...
                        const urlDown = getProcessoAnexoFileUrl(anexo, undefined, {
                          download: true,
                        })
                                  ...
                                  onClick={async () => {
                                    try {
                                      ...
                                      try {
                                        ...
                                        console.warn(
                                          'Erro ao registrar exclusão na timeline:',
                                          tlErr,
                                        )
                                      }
                    ...
                    <div className="rounded-lg border border-primary/30 bg-primary/5 p-3 space-y-2.5">
                      ...
                      <div className="space-y-2 pt-0.5">
                        {docsObrigatoriosProcesso.map((doc) => {
                          ...
                          const marcadoNestaEntrega =
                            documentosAdicionadosNestaEntrega.includes(doc)
      ...
      {/* Modal secundário de Edição do Evento Individual da Timeline independente do modal pai */}
      <Dialog
